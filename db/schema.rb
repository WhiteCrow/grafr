...
ActiveRecord::Schema.define(version: 20161110164520) do
  ...
  create_table "course_scores", force: :cascade do |t|
    ...
    t.index ["category"], name: "index_course_scores_on_category", using: :btree
    t.index ["course_id"], name: "index_course_scores_on_course_id", using: :btree
    t.index ["student_id"], name: "index_course_scores_on_student_id", using: :btree
  end
